...
KEY_MAX_WIDTH_CROPPED = 'max_width_cropped'
KEY_STARTING_STATE = 'starting_state'
KEY_DISTRO_SIZE = 'distro_size'
KEY_IMPORTANCE = 'importance'
KEY_STD_DEV_EVIDENCE = 'std_dev_evidence'
KEY_ANGLE_SPLIT = 'angle_split'
KEY_OVERALL_CHASE_TIMEOUT = 'overall_chase_timeout'
KEY_UNSEED_CHASE_TIMEOUT = 'unseen_chase_timeout'
